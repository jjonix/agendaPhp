		...
		$(document).ready(function() {
			...
			var calendar = $('#calendar').fullCalendar({
				...
				dayClick: function(date, allDay, jsEvent, view) {
					...
					window.location='agrevento.php?day='+ date.getDate()+'&month='+mes+'&year='+date.getFullYear();
				...
				<div class="container">
					...
					<div class="nav-collapse">
						<ul class="nav" style="float:right;">
							...
							<li><a  href="agrevento.php" style="color:#B32922;"><i class="icon-off"></i>Administración</a></li>
						</ul>
					</div><!--/.nav-collapse -->
				</div>
			</div>
